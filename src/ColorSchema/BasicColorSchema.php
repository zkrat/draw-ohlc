...
class BasicColorSchema extends AbstractColorSchema {
	...
	protected function configure() {
		...
		$this->colorArray['DrawOHLC\DrawImage\DrawBorder']['setColor']=Image::rgb(0,0,0);

		$this->colorArray['DrawOHLC\DrawImage\DrawOhlcList']['setColorBerish']=Image::rgb(255,0,0);
		$this->colorArray['DrawOHLC\DrawImage\DrawOhlcList']['setColor']=Image::rgb(0,0,0);

		$this->colorArray['DrawOHLC\DrawImage\DrawOhlc']['setColor']=Image::rgb(0,0,0);
		$this->colorArray['DrawOHLC\DrawImage\DrawOhlc']['setBgColor']=Image::rgb(0,0,0);
		...
		$this->colorArray['DrawOHLC\DrawImage\DrawOhlcList']['setBgColor']=Image::rgb(0,0,0);
		...
		$this->colorArray['DrawOHLC\DrawImage\DrawVolume']['setBgColor']=Image::rgb(0,0,0);
		$this->colorArray['DrawOHLC\DrawImage\DrawAvgVolume']['setBgColor']=Image::rgb(0,0,0);
		...
		$this->colorArray['DrawOHLC\DrawImage\DrawBgOhlcList']['setColorBullish']=Image::rgb(0,0,255);
		$this->colorArray['DrawOHLC\DrawImage\DrawBgOhlcList']['setWickColor']=Image::rgb(255,255,255);
		$this->colorArray['DrawOHLC\DrawImage\DrawBgOhlcList']['setBgColor']=Image::rgb(0,0,0);
		$this->colorArray['DrawOHLC\DrawImage\DrawBgOhlcList']['setColor']=Image::rgb(255,255,255);
		$this->colorArray['DrawOHLC\DrawImage\DrawCanvas']['setBgColor']=Image::rgb(255,255,255);
